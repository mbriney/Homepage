...
<section class="case-hero">
  <div class="container">
    ...
    <div class="meta-row">
      ...
      <div class="meta-item"><span class="label">Cadence</span><span class="value">Weekly, fully automated</span></div>
    </div>
...
<div class="case-content">
  ...
  <p>I wanted the third path: turn the entire Grant operation into a weekly, push-button run that audits the account, finds the gaps, proposes a plan, and &mdash; after I approve &mdash; ships changes via API.</p>

  <h2>How it works</h2>
  <p>The optimizer runs as a Claude skill against a live Google Ads account. Every weekly run follows the same loop:</p>
  ...
  <nav class="case-nav" aria-label="Case study navigation">
    <a class="prev" href="/projects/annual-reports/"><span class="dir">&larr; Previous</span><span class="title">A Tale of Two Annual Reports</span></a>
