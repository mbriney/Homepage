...
<div class="case-content">
  ...
  <div class="gallery cols-2">
    ...
    <figure>
      <picture>
        ...
        <img src="/img/projects/tr-llm/02.jpg" alt="Archival file boxes in the Library's collections workroom, their hand-labelled tab dividers reading Ted, Eleanor, Alice Lee, Quentin, Finances, Animals, White House, alongside sleeved ephemera on a table" loading="lazy" width="1600" height="900">
      </picture>
      <figcaption class="gallery-caption">What a record actually looks like before any of this works: paper, in boxes, behind hand-lettered tabs. Answers resolve to items like these, catalogued and linked out to the <a href="https://www.theodorerooseveltcenter.org/" target="_blank" rel="noopener">Theodore Roosevelt Center</a>&rsquo;s digital archive.</figcaption>
    </figure>
  </div>
  ...
  <p>Answers average <strong>8.4 citations</strong>, and each one carries the creator, recipient, date, collection, repository and a permalink to the source record &mdash; paper records, catalogued and resolvable into the <a href="https://www.theodorerooseveltcenter.org/" target="_blank" rel="noopener">Theodore Roosevelt Center</a>&rsquo;s digital archive at Dickinson State University. Where a field in the underlying catalogue was machine-generated rather than written by a human archivist, the record says so. An institution that publishes AI-assisted metadata without labelling it is quietly degrading its own catalogue; labelling it costs nothing and preserves the distinction permanently.</p>
  ...
  <div class="gallery cols-1">
    <figure>
      <picture>
        ...
        <img src="/img/projects/tr-llm/03.jpg" alt="The Talk to TR exhibit — a full-scale digital Theodore Roosevelt standing at his desk in a recreated White House study, with period photographs on the wall behind him" loading="lazy" width="1600" height="900">
      </picture>
      <figcaption class="gallery-caption"><em>Talk to TR</em> in the permanent exhibition &mdash; Roosevelt at his desk, at full scale. The same grounded retrieval that answers a question in the browser answers one out loud here, in a room, to whoever walks up. <span class="muted">Image: Microsoft.</span></figcaption>
    </figure>
  </div>
