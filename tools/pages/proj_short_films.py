...
<div class="case-content">
  ...
  <p>The films were produced on location at Mount Vernon and beyond &mdash; on set, on premiere night, and everywhere in between.</p>
  <div class="gallery cols-3">
    <figure>
      <picture><source type="image/webp" srcset="/img/projects/short-films/religious-freedom-set.webp"><img src="/img/projects/short-films/religious-freedom-set.jpg" alt="On location for George Washington and the Pursuit of Religious Freedom in Newport, Rhode Island" loading="lazy"></picture>
      <figcaption class="gallery-caption"><em>George Washington and the Pursuit of Religious Freedom</em> &mdash; Newport, Rhode Island, 2021.</figcaption>
    </figure>
    <figure>
      <picture><source type="image/webp" srcset="/img/projects/short-films/winter-patriots-set.webp"><img src="/img/projects/short-films/winter-patriots-set.jpg" alt="On set for The Winter Patriots" loading="lazy"></picture>
      <figcaption class="gallery-caption">On set for <em>The Winter Patriots</em> &mdash; 2017.</figcaption>
    </figure>
    <figure>
      <picture><source type="image/webp" srcset="/img/projects/short-films/mv-filming-2016.webp"><img src="/img/projects/short-films/mv-filming-2016.jpg" alt="A film crew shooting at Mount Vernon" loading="lazy"></picture>
      <figcaption class="gallery-caption">A Mount Vernon film shoot &mdash; 2016.</figcaption>
    </figure>
  </div>
  ...
  <nav class="case-nav" aria-label="Case study navigation">
    <a class="prev" href="/projects/numismatic-kiosk/"><span class="dir">&larr; Previous</span><span class="title">Numismatic Kiosk</span></a>
